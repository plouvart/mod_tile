...
struct projectionconfig *get_projection(const char *srs)
{
	...
	if (strstr(srs, "+proj=merc +a=6378137 +b=6378137") != NULL) {
		...
		prj->bound_x0 = 0.0;
		prj->bound_y0 = 0.0;
		prj->bound_x1 = 36885035.64084;
		prj->bound_y1 = 36885035.64084;
		// prj->bound_x0 = -18421881.03421;
		// prj->bound_y0 = -18421881.03421;
		// prj->bound_x1 = 18421881.03421;
		// prj->bound_y1 = 18421881.03421; 
		prj->aspect_x = 1;
		prj->aspect_y = 1;
